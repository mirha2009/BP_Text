...
\begin{table}[htbp]
	...
	\begin{tabular}{l|c c c c c c c c}
		...
		\begin{tabular}[c]{@{}l@{}}Sdílení vizualizací\end{tabular}                      & +                                                        & --                                                           & --                                                     &  \tikz\draw[black,fill=black] (0,0) circle (.5ex);                                                         & +                                                        & --                                                        & +       & +      \\ 
		\begin{tabular}[c]{@{}l@{}}Strojové učení na detekci\\ anomálií\end{tabular}     & --                                                        & +                                                           & +                                                     & --                                                         & --                                                        & --                                                        & +       & \tikz\draw[black, thick] (0,0) circle (.5ex);      \\ 
		...
		Cena                                                                               & \begin{tabular}[c]{@{}c@{}} \\
			...
			\textbf{*}\end{tabular}                                                     & F                                                  & \begin{tabular}[c]{@{}c@{}}\tikz\draw[red,fill=red] (0,0) circle (.5ex);\end{tabular} & F                                                     & F                                                     & X     & F   \\ \hline
	\end{tabular}
