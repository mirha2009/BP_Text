...
\begin{table}[]
	...
	\end{tabular}
	\caption{Počet recenzí jednotlivých zemí}
	\label{Pocet_zeme}
\end{table}
\newpage
\noindent
...
\begin{figure} [htbp]
	\centering
	\includegraphics[width= \textwidth]{img/detail_spojeni.eps}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width = 12cm]{img/Business_trip_customers_proportions.eps}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[ width = 10cm]{img/Leisure_trip_customers_proportions_cut.eps}
