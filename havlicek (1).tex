...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
		...
		Dashboardy                                                                         & +                                                        & +                                                           & +                                                     & +                                                         & +                                                        & -                                                        & +       & +      \\ \hline
		\begin{tabular}[c]{@{}l@{}}Kompatibilita s Elastic- \\search\end{tabular}            & -                                                        & -                                                           & -                                                     & -                                                         & -                                                        & -                                                        & -       & +      \\ \hline
...
%	\item[]
	...
	\\	 \textbf{+} : Produkt splňuje kritérium.
	\\	 \textbf{--} : Produkt nesplňuje kritérium.
	\\	 * : Doživotní licence omezená přenosem 5GB za den. Cena za GB.
...
Indexy se od sebe liší pouze obsahem polí \textit{HOTEL\_NAME\_SUGGEST}, \textit{HOTEL\_NAME\_SUGGEST\_TOKENS} a DATE\_CREATED\_SEASONS. Ta\-to pole a jejich data nebyla v původní verzi k dispozici, ale vznikla až v průběhu práce, protože byla nezbytná k jejímu zdárnému dokončení. 
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|c|c|}
		...
		\textbf{Australia}      & 15 734                                           & 253                                         \\ \hline
...
\begin{figure}[h]
	...
	\centering
	\includegraphics[ width =\linewidth]{img/food.eps}
	\caption{Spokojenost hostů s jídlem}
	\label{fig:Food_sentiment}	
	\end{minipage}
	\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[ width = \linewidth]{img/food_positive.eps}
...
Jelikož otázka žádá odpověď na vztah mezi celkovým hodnocením hotelů a jejich stavem, je maticová agregace ideálním nástrojem jak tento vztah vyjádřit. Hledáme tedy vztah mezi polem SCORE\_TOTAL  a polem SCO- RE\_HOTEL\_CONDITION/CLEANLINESS. Z výsledku agregace nás zajímá pouze sekce s korelací. V následující tabulce \ref{my-label} je vidět výsledek korelace mezi zvolenými poli. Pole SCORE\_TOTAL je reprezentováno hodnotou F1 a hodnota F2 reprezentuje pole SCORE\_HOTEL\_CONDI- TION/CLEANLINESS.
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\textbf{F1}     & 1               & 0,8524          & -0,0331         \\ \hline
		\textbf{F2}     & 0,0228          & 1               & -0,0636         \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|l|c|c|c|}
		...
		\textbf{SCORE\_TOAL}                                                                     & 273 559                                                                                   & 72,65\%                                                                               & 7.32              \\ \hline
		\textbf{SCORE\_LOCATION}                                                                 & 185 931                                                                                   & 49,38\%                                                                               & 8.08              \\ \hline
		\textbf{\begin{tabular}[c]{@{}l@{}}SCORE\_HOTEL\_CON-\\DITION/CLEANLINESS\end{tabular}} & 186 071                                                                                   & 49,41\%                                                                               & 7.98              \\ \hline
		\textbf{\begin{tabular}[c]{@{}l@{}}SCORE\_SER-\\VICE\_STAFF\end{tabular}}                                                           & 186 148                                                                                   & 49,43\%                                                                               & 7.87              \\ \hline
		\textbf{\begin{tabular}[c]{@{}l@{}}SCORE\_ROOM\_COM-\\ FORT/STANDARD\end{tabular}}       & 196 185                                                                                   & 52\%                                                                               & 7.86              \\ \hline
		\textbf{SCORE\_FACILITIES}                                                               & 181 120                                                                                   & 48\%                                                                               & 7.49              \\ \hline
		\textbf{\begin{tabular}[c]{@{}l@{}}SCORE\_LUE\_FOR\_MO-\\NEY\end{tabular}}            & 168 220                                                                                   & 44,67\%                                                                               & 7.45              \\ \hline
		\textbf{SCORE\_FREE\_WIFI}                                                               & 103 804                                                                                   & 27\%                                                                               & 7.42              \\ \hline
	\end{tabular}
